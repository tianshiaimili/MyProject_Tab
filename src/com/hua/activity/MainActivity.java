...
import com.hua.R;
import com.hua.fragment.utils.FragmentUtils;
import com.hua.fragment.utils.FragmentUtils.FragmentTabBarController;
import com.hua.fragment.utils.FragmentUtils.FragmentTabSwitcher;
		...
		mFragmentTabBarController = new FragmentTabBarController(this, (LinearLayout)findViewById(R.id.tab_bar_container), true) {
			...
			public View getView(int position, View convertView, ViewGroup viewgroup,
				...
				case 0:
					...
					lable.setText(R.string.tab2_bar_tv_series);
					convertView.setTag(TAB_HOME);
					
					break;
				case 1:
					icon.setImageResource(R.drawable.tab_movie_selector);
					lable.setText(R.string.tab2_bar_movies);
